// Escopo léxico: a função conhece o local onde ela foi declarada (criada), tudo que tá declarado dentro dela e e ela sabe os vizinhos dela.
...
// Se tiver essa variável 'nome' no escopo global, vai ser exibido o valor de 'nonme'.
