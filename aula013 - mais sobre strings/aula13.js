...
console.log(umaString.search('U')) // Função que retorna o índice de determinado valor; Muito similar ao indexOf(), mas ele aceita expressões regulares. // Resultado: 0
